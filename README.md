...
## Updates
Jul 6, 2023: Add pytorch-ctc feature. The performance on document dataset is [here](images/performance_on_document_dataset.png). It is recommended to use pytorch-ctc, because compared to warp-ctc, pytorch-ctc is faster trained and has considerable performance. If you still want to use warp-ctc, you can use this [github](https://github.com/johnson-magic/warp-ctc-pytorch1.x), which update pytorch dependency version from 0.4 to 1.12.
